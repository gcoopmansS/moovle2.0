...
export function TennisIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    ...
    >
      ...
      {/* Tennis ball seam - two intersecting curved lines like real tennis balls */}
      <path
        d="M6 4 Q12 12, 6 20"
        strokeWidth="2"
        fill="none"
...
export function PadelIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      {/* Padel racket head - much rounder, almost circular, centered */}
      <rect x="7" y="3" width="10" height="12" rx="5" strokeWidth="2" />
      {/* Holes in padel racket */}
      ...
      {/* Handle - centered */}
      <rect x="11" y="15" width="2" height="6" strokeWidth="2" rx="1" />
      {/* Grip wrap lines */}
      <line x1="11" y1="17" x2="13" y2="17" strokeWidth="1" />
      <line x1="11" y1="19" x2="13" y2="19" strokeWidth="1" />
    </svg>
  );
}
...
export function SleepIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function BadmintonIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
